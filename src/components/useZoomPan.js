...
export default function useZoomPan({
  ...
  function handleWheel(event) {
    // fix: removed event.ctrlKey to enable mouse wheel zoom
    const isMouseWheelZoomDisabled =
      typeof disableMouseWheelZoom === 'function' ? disableMouseWheelZoom(event) : disableMouseWheelZoom;

    if (isMouseWheelZoomDisabled) return;
